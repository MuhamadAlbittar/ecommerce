    ...
    <div class="card-service-section px-0 px-md-0 px-lg-3">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center bg-teal">
                ...
                <span class="text-white fw-semibold">Add New Vendor</span>
                <div></div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="card shadow-sm border-0 border-radius-12">
                <div class="card-body p-4">
                    <h5 class="fw-bold mb-4">New Vendor Information</h5>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" rows="3"
                                          ...
                                          placeholder="Brief description about this vendor...">{{ old('description') }}</textarea>
                                @error('description')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Vendor Logo</label>
